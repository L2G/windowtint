# This example comes directly from the term-ansicolor gem by Florian Frank
# (https://github.com/flori) and is licensed under the terms of the GNU
# General Public License (GPL) version 2.
#
# The only modification made was to add the 'windowtint' line.
